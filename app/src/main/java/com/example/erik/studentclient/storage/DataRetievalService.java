...
import com.example.erik.studentclient.parseresponse.DataParserException;
...
public class DataRetievalService implements DataRetriever {
    ...
    private static String className[] = {"com.example.erik.studentclient.storage.JSONMockDataRetriever"};
